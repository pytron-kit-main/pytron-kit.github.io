export default function Menus() {
    return (
        <div className="prose">
            ...
            <p>
                Pytron provides a high-level abstraction for managing native system menus and tray icons. This allows you to build applications that feel like they belong on the user's desktop, with integrated OS-level shortcuts and persistent presence in the system tray.
            </p>
            ...
            <pre><code className="language-python">{`from pytron import App, Menu, MenuBar
...
app.run()`}</code></pre>
            ...
            <ul>
                ...
                <li><strong>Standard Templates:</strong> Quickly scaffold common menus like "Show/Hide/Quit".</li>
            </ul>

            <pre><code className="language-python">{`# Manual setup
...
app.setup_tray_standard()`}</code></pre>

            <h2>3. Global Shortcuts</h2>
            <p>
                Shortcuts registered via the <code>App</code> class are "Global"—meaning they trigger even when your window is minimized or out of focus.
            </p>
            <pre><code className="language-python">{`@app.shortcut("Ctrl+Shift+Space")
def quick_action():
    app.show()
    app.emit("start-search")`}</code></pre>
